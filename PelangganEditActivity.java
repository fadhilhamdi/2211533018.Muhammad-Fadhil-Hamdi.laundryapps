...
import com.qkeglf.felaundry.database.SQLiteHelper;
import com.qkeglf.felaundry.Constant;
...
public class PelangganEditActivity extends AppCompatActivity {
    ...
    public Button getBtnPelEditSimpan() {
        return btnPelEditSimpan;
    }

    public void setBtnPelEditSimpan(Button btnPelEditSimpan) {
        this.btnPelEditSimpan = btnPelEditSimpan;
    }
}