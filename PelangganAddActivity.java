package com.qkeglf.felaundry.pelanggan;
...
import com.qkeglf.felaundry.Model.ModelPelanggan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(cek == true){
                    Toast.makeText(PelangganAddActivity.this, "Data berhenti disimpan", Toast.LENGTH_SHORT).show();
